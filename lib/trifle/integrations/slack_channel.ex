defmodule Trifle.Integrations.SlackChannel do
  use Ecto.Schema
  ...
  @required_fields ~w(slack_installation_id channel_id name channel_type)a
  @optional_fields ~w(is_private enabled metadata)a
  ...
  schema "slack_channels" do
    ...
    belongs_to :installation, SlackInstallation, foreign_key: :slack_installation_id
