defmodule TrifleWeb.FilterComponents do
  ...
  def filter_input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        id={@id}
        name={@name}
        class="block w-full rounded-md border-0 py-1.5 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-500 sm:text-sm sm:leading-6"
        multiple={@multiple}
        {@rest}
      >
  ...
  def filter_input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "block w-full rounded-md border-0 py-1.5 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6",
  ...
  def filter_label(assigns) do
    ~H"""
    <label for={@for} class="absolute -top-2 left-2 inline-block bg-gray-100 px-1 text-xs font-medium text-gray-900">
