      ...
      <div class="sm:p-4">
        <div class="border-b border-gray-200">
          <nav class="-mb-px space-x-8" aria-label="Tabs">
            ...
            <.link navigate={~p"/app/projects/#{@project.id}/settings"} class="float-right border-teal-500 text-teal-600 group inline-flex items-center border-b-2 py-4 px-1 text-sm font-medium" aria-current="page">
