                  ...
                  <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    ...
                    <div class="flex-shrink-0 border-t border-gray-200 px-4 py-5 sm:px-6">
                      <div class="flex justify-end space-x-3">
                        <.link navigate={~p"/app/projects/#{@project.id}/tokens"} class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Done</.link>
                      </div>
                    </div>
                  </div>
                <% else %>
