defmodule TrifleApp.UserAuth do
  ...
  the current_user:
      ...
      defmodule TrifleApp.PageLive do
        use TrifleApp, :live_view

        on_mount {TrifleApp.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TrifleApp.UserAuth, :ensure_authenticated}] do
