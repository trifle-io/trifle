defmodule TrifleApp.ProjectTokensLive do
  ...
  def render(assigns) do
        ...
        <div class="border-b border-gray-200">
          <nav class="-mb-px space-x-8" aria-label="Tabs">
            ...
            <.link
              ...
              class="float-right border-teal-500 text-teal-600 group inline-flex items-center border-b-2 py-4 px-1 text-sm font-medium"
              aria-current="page"
            >
              <svg
                      ...
                      <div class="bg-gray-50 px-4 py-6 sm:px-6">
                        <div class="flex items-start justify-between space-x-3">
                          ...
                          <div class="text-gray-400 hover:text-gray-500">
                            <.link navigate={~p"/projects/#{@project.id}/tokens"} class="">
                      ...
                      <div class="space-y-6 py-6 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0">
                        <div class="space-y-2 px-4 sm:grid sm:grid-cols-1 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                          ...
                          <span
                            ...
                            class="rounded-md font-mono text-lg px-2 w-auto max-w-max break-normal text-red-700 bg-red-100"
                          >
                            {@token.token}
                          </span>
                        ...
                        <div class="flex items-start justify-between space-x-3">
                          <div class="space-y-1">
                            ...
                            <p class="text-sm text-gray-500">
                              Create new Token to access project programatically. You know, to push some data into it.
                            </p>
                          </div>
                          <div class="text-gray-400 hover:text-gray-500">
                            <.link navigate={~p"/projects/#{@project.id}/tokens"} class="">
    ...
    <.link navigate={~p"/projects/#{@project.id}/tokens/new"} class="">New</.link>
          ...
          <li>
            <div class="block">
              <div class="flex items-center px-4 py-4 sm:px-6">
                  ...
                  <div class="truncate">
                    <div class="flex text-sm">
                      ...
                      <p class="ml-1 flex-shrink-0 font-normal text-gray-500">
                        ending <span class="text-red-500">{String.slice(token.token, -5, 5)}</span>
                      </p>
                    </div>
                    <div class="mt-2 flex">
                      <div class="flex items-center text-sm text-gray-500">
                        ...
                        <p>
                          ...
                          <time datetime="2020-01-07">
                            {Calendar.strftime(token.updated_at, "%y-%m-%d %I:%M:%S %p")}
                          </time>
                        </p>
                      </div>
                    </div>
                ...
                <button
                  class="ml-20 flex-shrink-0"
                  phx-click="delete"
                  phx-value-id={token.id}
                  data-confirm="Are you sure?"
                >
                  <svg
                    class="h-5 w-5 text-teal-500 hover:text-teal-800"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
