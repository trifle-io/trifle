  ...
  def nav(assigns) do
    ...
    <div class="mb-6 border-b border-gray-200 dark:border-slate-700">
      <nav class="-mb-px flex flex-wrap gap-4" aria-label="Organization tabs">
        ...
        <.link navigate={~p"/organization/tokens"} class={tab_link_classes(@active_tab == :tokens)}>
          <svg
        ...
        >
          <svg
            class={tab_icon_classes(@active_tab == :delivery)}
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            stroke-width="1.5"
          ...
          <span class="hidden sm:block">Delivery options</span>
        </.link>
