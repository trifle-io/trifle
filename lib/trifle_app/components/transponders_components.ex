                      ...
                      >
                        ...
                        >
                          <path
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            d="M8.25 7.5V6.108c0-1.18.91-2.164 2.09-2.201a48.387 48.387 0 013.32 0c1.18.037 2.09 1.022 2.09 2.201V7.5m-7.5 0h7.5m-7.5 0H5.692a2.25 2.25 0 00-2.244 2.077L3 19.299A2.25 2.25 0 005.244 21h9.512A2.25 2.25 0 0017 19.299l-.448-9.722a2.25 2.25 0 00-2.244-2.077H8.25m3 4.125v6.375m3.375-6.375L14.25 17.25m-3.375-6.375L9.75 17.25"
                          />
                        </svg>
                      </button>
