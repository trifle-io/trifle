    ...
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-3">
      <div class="space-y-6 xl:col-span-2">
        <MetricSeriesEditor.editor
          ...
          path_help="Path rows can target wildcard bucket groups."
        />
      ...
      <div class="space-y-4">
        <div>
          ...
          <%= if @is_heatmap do %>
            ...
            <div class="rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-700 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100">
              Heatmap
            </div>
          <% else %>
            <select
              name="dist_mode"
              class="block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-teal-500 focus:outline-none focus:ring-teal-500 dark:border-slate-600 dark:bg-slate-700 dark:text-white sm:text-sm"
            >
            ...
            <div class="grid grid-cols-1 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="single" selected={@heatmap_color_mode == "single"}>
                    Single color
                  </option>
              ...
              <%= if @heatmap_color_mode == "single" do %>
                <div>
                  ...
                  <input
                    ...
                    class="h-10 w-16 rounded-md border border-gray-300 bg-white p-1 dark:border-slate-600 dark:bg-slate-700"
                  />
                </div>
              <% end %>
              ...
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 disabled:cursor-not-allowed disabled:opacity-70 dark:border-slate-600 dark:bg-slate-700 dark:text-white sm:text-sm"
                  />
                </div>
              </div>
            <% end %>
      ...
      >
        <div data-type="custom" class={designator_field_class(@selected_type == "custom")}>
          ...
          <textarea
            ...
            rows="3"
            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 dark:border-slate-600 dark:bg-slate-700 dark:text-white sm:text-sm"
