    ...
    <div class="space-y-4">
      ...
      >
        ...
        <p class="text-xs text-gray-500 dark:text-slate-400">
          Provide a parent path (e.g., <code>payment_methods</code> or <code>payment_methods.*</code>). Matching children render in the table with the provided prefix removed so long names stay readable.
        </p>
      </div>
    </div>
    """
