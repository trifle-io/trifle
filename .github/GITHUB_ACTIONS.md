...
- **Push tags (v*)**: Builds and pushes `trifle/app` and `trifle/network-gateway` with the git tag
...
- `trifle/network-gateway:1.2.3` (when you tag releases like `v1.2.3`)
...
```
This creates `trifle/app:1.0.0` and `trifle/network-gateway:1.0.0` images.
